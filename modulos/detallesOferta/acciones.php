...
function traerDatosOferta(){
  ...
  cosechas.fecha_inicio, cosechas.fecha_final, cosechas.estado, productos.frecuencia AS frecuencia, productos.id AS id_producto, productos.nombre AS producto, productos.presentacion AS presentacion, productos.reg_invima AS invima, fincas.nombre AS finca, 
