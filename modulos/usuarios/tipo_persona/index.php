<?php  
  ...
  if ($permisos->validarPermiso($usuario['id'], 'usuarios_tipo_persona') == 0) {
...
<body>
  ...
  <div div class="content-header">
    <div class="container">
      ...
      <div class="row mb-2">
        <div class="col-12">
          <h1 class="m-0 text-dark"><i class="far fa-user"></i> Tipo persona</h1>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="tituloModal"><i class="fas fa-plus"></i> Crear tipo persona</h5>
        </div>
        <form id="formCrear" autocomplete="off">
          ...
          <div class="modal-body">
            <div class="form-group">
              ...
              <input type="text" name="nombre" class="form-control" placeholder="Escriba el nombre del tipo de persona" required autocomplete="off">
            </div>
          </div>
...
<script>
  $(function(){
    ...
    $('.btnCrear').on("click", function(){
      $("#tituloModal").html(`<i class="fas fa-plus"></i> Crear tipo persona`);
    ...
    $(document).on("click", ".btnEditar", function(){
      ...
      $("#tituloModal").html(`<i class="fas fa-edit"></i> Editar tipo persona | ` + datos['nombre']);
