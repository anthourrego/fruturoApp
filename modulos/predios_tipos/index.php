<?php  
  ...
  if ($permisos->validarPermiso($usuario['id'], 'predios_tipos') == 0) {
...
<body>
  ...
  <div div class="content-header">
    <div class="container">
      ...
      <div class="row mb-2">
        <div class="col-12">
          <h1 class="m-0 text-dark"><i class="fas fa-home"></i> Tipos predios</h1>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  </div>
        ...
        <form id="formCrear" autocomplete="off">
          ...
          <div class="modal-body">
            <div class="form-group">
              ...
              <input type="text" name="nombre" class="form-control" placeholder="Escriba el nombre del tipo predio" required autocomplete="off">
            </div>
          </div>
...
<script>
  $(function(){
    ...
    $('.btnCrear').on("click", function(){
      $("#tituloModal").html(`<i class="fas fa-home"></i> Crear tipo predio`);
    ...
    $(document).on("click", ".btnEditar", function(){
      ...
      $("#tituloModal").html(`<i class="fas fa-edit"></i> Editar tipo predio | ` + datos['nombre']);
