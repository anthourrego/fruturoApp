...
<script>
  $(function(){
    ...
    $('.btnCrear').on("click", function(){
      $("#tituloModal").html(`<i class="fas fa-plus"></i> Crear terreno`);
  ...
  function eliminar(datos){
    Swal.fire({
      title: "¿Estas seguro de eliminar el terreno " + datos['nombre'] + "?",
      icon: 'warning',
          ...
          success: function(data){
            if (data == 1) {
              ...
              Swal.fire({
                ...
                position: 'bottom-end',
                icon: 'success',
                title: "Se ha eliminado el terreno " + datos['nombre'],
                showConfirmButton: false,
                timer: 5000
              });
            }else{
              Swal.fire({
                icon: 'warning',
                html: "Error al eliminar el terreno " + datos['nombre']
              })
            }
          },
          error: function(){
